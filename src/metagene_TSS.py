...
def run(file1,file2,file3):
    ...
    ax1.text(500,0.225,"Time in higher CA: " + str(CAtime) + "\nTime in higher DMSO: " + str(DMSOtime) + "\nCA integration: " + str(CAtot) + "\nDMSO integration: " + str(DMSOtot),fontsize=8)
    ax2 = F1.add_subplot(2,1,2)
    ax2.plot(x2,CAantiarray-DMSOantiarray,color='r')
    ax2.set_title('CA-DMSO antisense')
    ax2.text(500,0.3,"Time in higher CA antisense: " + str(CAtimea) + "\nTime in higher DMSO antisense: " + str(DMSOtimea) + "\nCA integration antisense: " + str(CAtota) + "\nDMSO integration antisense: " + str(DMSOtota),fontsize=8)
